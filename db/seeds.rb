...
cilantro = Plant.crete!(name: 'Cilantro', description: 'Needs light breexe for stronger stems.', days_to_harvest: 20)
...
PlotPlant.create!(plot_id: bg2.id, plant_id: parsley.id)
PlotPlant.create!(plot_id: bg2.id, plant_id: mint.id)
